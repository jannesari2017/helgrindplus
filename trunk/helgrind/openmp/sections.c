...
unsigned
hgGOMP_sections_start (unsigned count)
{
...
void
hgGOMP_parallel_sections_start (void (*fn) (void *), void *data,
...
void
hgGOMP_sections_end (void)
{
  gomp_work_share_end ();
}

void
hgGOMP_sections_end_nowait (void)
{
