...
/* Shadow value encodings:
   ...
   110 0 0--WordSetID:28--0  00 0------VtsID:30--------0   ShM2  lock-set + vector-set
   101 0 0--WordSetID:28--0  00 0---------(30)---------0   ShM  lock-set
   100 0 0--WordSetID:28--0  00 0---------(30)---------0   ShR  lock-set
   011 0--(29)--0            00 0------VtsID:30--------0   ExclRW vector-set
   010 0--(29)--0            00 0------VtsID:30--------0   ExclR vector-set
   001 0--(29)--0            00 0------VtsID:30--------0   ExclW vector-set
...
static inline SVal SVal__mk_ShM2 ( VtsID vtsid,  WordSetID lset ) {
   if (LIKELY(SVal__is_sane_WordSetID_LSet(lset))) {
      return (((SVal)6) << 61)
             | (((SVal)lset)  << SVAL__N_LSID_SHIFT)
             | (((SVal)vtsid) << SVAL__N_VTSID_SHIFT);
   } else {
      SVal__mk_fail(lset, vtsid, "mk_SHVAL_ShM2");
   }
}

//TODO_KA: change SVal__mk_ShM accordingly
...
static inline SVal SVal__mk_ExclRW ( VtsID vtsid ) {
   //tl_assert(VtsID__is_valid(vtsid));
   return (((SVal)3) << 61)
          | (((SVal)vtsid & SVAL__N_VTSID_MASK) << SVAL__N_VTSID_SHIFT);
}
...
static inline Bool SVal__is_ShM2 ( SVal sv ) {
   return (sv >> 61) == 6;
}
...
static inline Bool SVal__is_Sh ( SVal sv ) {
   return (SVal__is_ShM(sv) || SVal__is_ShM2(sv) || SVal__is_ShR(sv));
}

static inline Bool SVal__is_ExclRW ( SVal sv ) {
   return (sv >> 61) == 3;
}
...
static inline Bool SVal__is_tracked ( SVal sv ) {
   return SVal__is_ExclW(sv) || SVal__is_ExclR(sv) || SVal__is_ExclRW(sv) || SVal__is_Sh(sv) || SVal__is_New(sv) ;
}

static inline Bool SVal__has_VTS ( SVal sv ) {
   return SVal__is_ExclW(sv) || SVal__is_ExclR(sv) || SVal__is_ExclRW(sv)
       || SVal__is_ShM2(sv) || SVal__is_ShM(sv) || SVal__is_ShR(sv)
       || SVal__is_SpinVar(sv);
}
