...
WordSetU* univ_tsets; /* sets of Thread* */
WordSetU* univ_lsets; /* sets of Lock* */
WordSetU* univ_laog;  /* sets of Lock*, for LAOG */
...
/* ThrLSD, hg_lsd's private thread record, exported abstractly */
typedef  struct _ThrLSD ThrLSD;
typedef  struct _LockLSD LockLSD;

/* ThrLoopExtends, hg_loops' private thread record, exported abstractly */
typedef  struct _ThreadLoopExtends ThreadLoopExtends;
...
typedef
   struct _Lock {
      ...
      LockLSD*      lsdlock;/* Lock structure of LSD-module */
      /* EXPOSITION */
