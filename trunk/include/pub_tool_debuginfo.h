...
/* This returns the name of a dynamically loaded library function which has a
   jumpslot at address 'a'. This function can be used during instrumentation.
   (Valgrind normally overwrites library functions. This way we get no
   information about the code which called the library function. With this you
   can detect a library call during instrumentation and find out about the
   context of the caller.) */
extern Bool VG_(get_jumpslot_fnname)
                              ( Addr a, Char* fnname, Int n_fnname );
